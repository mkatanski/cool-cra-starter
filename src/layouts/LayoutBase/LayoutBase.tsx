...
export interface LayoutBaseProps extends RouteProps {
  /**
   * Component rendered by fallback route. By default its 'pages/errors/NotFoundView'
   */
  fallbackRouteComponent?: ComponentType;
  /**
   * If true append default route if react-router switch can't match current path
   */
